...
\input{tables/tof_badpaddles_additionalko}
...
To summarize, the final, combined TOF paddle knock out is listed in the table below:

\begin{table}
\begin{center}
\begin{singlespacing}

\caption{\label{tab:tofko_recommended} Recommended list of paddles to knockout.}
