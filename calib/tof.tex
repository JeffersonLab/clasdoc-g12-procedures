...
\begin{figure}\begin{center}
   \begin{minipage}{0.475\columnwidth}
      \includegraphics[width=0.95\columnwidth]{figures/calib/tof/tofko/res_sec2_scid36_p.eps}
   \end{minipage}
   \hfill
   \begin{minipage}{0.475\columnwidth}
      \includegraphics[width=0.95\columnwidth]{figures/calib/tof/tofko/res_sec2_scid36_m.eps}
   \end{minipage}
   \caption{\label{plot:example.tofdiff}Example plots of measured time-of-flight and expected time-of-flight for paddle 36 in sector 2. Left plot is for positively charged tracks and right is for negatively charged tracks.}
\end{center}\end{figure}
