\subsection{\label{sec:calib.tof}Time-of-Flight Counter}
...
\begin{table}
\begin{tabular}[!htbp]{l|l|p{.43\textwidth}} %l | l | >{\centering\arraybackslash}p{.45\textwidth} |}
Sector & SCID & Notes \\
\hline
...
\begin{table}
\begin{tabular}[!htbp]{l|p{.43\textwidth}|p{.43\textwidth}} %l | >{\centering\arraybackslash}p{.43\textwidth} | >{\centering\arraybackslash}p{.43\textwidth} |}
