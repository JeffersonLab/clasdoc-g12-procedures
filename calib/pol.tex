...
\begin{center}
 %\includegraphics[width=0.4\textwidth]{figures/calib/pol/myIo.eps}
  ...
  \includegraphics[0.4\textwidth]{figures/calib/pol/iodotcompare.eps}
  \caption{$I_{\odot}(\phi^{hel}_{\pi^+})$ comparison between g12 and g1c within the energy range $W = 2.05 \pm .025 GeV$}
  \label{myIo}
  \end{center}
\end{figure}
