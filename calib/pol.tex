\subsection{\label{sec:calib.pol}Beam Polarizatoin}
...
\begin{table}[h]
  \centering
  \includegraphics[width=0.5\linewidth]{moltable}
...
\begin{table}[h]
  \centering
  \includegraphics[width=1\linewidth]{photable}
...
\twocap{0.7}{ioplane}{An illustration of the angle definitions used in the $\gamma p \to \pi^+ \pi^- p$ sub-analysis.}{An illustration of the angle definitions used in the $\gamma p \to \pi^+ \pi^- p$ sub-analysis. $\theta_{cm}$ is defined in the center-of-mass frame. $\theta$ and $\phi$ are defined in the rest frame of the $\pi^+$ $\pi^-$ system as the polar and azimuthal angles. The $z$ direction is along the total momentum of the $\pi^+ \pi^-$ system. Image source~\cite{Io}}
\onefig{0.7}{myIo}{ $I_{\odot}(\phi^{hel}_{\pi^+})$ for our data within the energy range of $W = 1.9-2.3$ GeV.}
\twocap{0.7}{Io}{$I_{\odot}(\phi^{hel}_{\pi^+})$ as measured in the previous analysis.}{ $I_{\odot}(\phi^{hel}_{\pi^+})$ as measured in the analysis~\cite{Io}. The results of are shown in bins of $W$ from $1.9$ to 2.3 GeV.}
