...
\begin{figure}\begin{center}
   ...
   \caption{\label{plot:example.badsector5}TOF resolution as a function of run number for a bad paddle}
\end{center}\end{figure}
