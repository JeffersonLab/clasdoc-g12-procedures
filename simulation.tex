...
\end{verbatim}
Using the above command, should create a gsim bos outfile. Here is the FFREAD file should be used to run gsim\_bat for \desg{g12} analyses not using electrons/positrons:
\begin{verbatim}
===BEGIN=====FFREAD.G12======================
