...
\begin{itemize}
    \item \fullcite{clas.thesis.goetz}
    \item \fullcite{clas.thesis.bookwalter}
    \item \fullcite{clas.thesis.schott}
    \item \fullcite{clas.thesis.saini}
    \item \fullcite{clas.thesis.bono}
\end{itemize}
