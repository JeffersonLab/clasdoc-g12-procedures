...
\begin{figure}[htpb]\begin{center}
\includegraphics[width=1.1\columnwidth]{{figures/xsec/cross_omega_1}.eps}
...
\begin{figure}[htpb]\begin{center}
\includegraphics[width=1.1\columnwidth]{{figures/xsec/cross_omega_2}.eps}
