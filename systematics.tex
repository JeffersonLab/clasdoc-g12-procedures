...
\begin{figure}[htpb]\begin{center}
\includegraphics[width=\columnwidth]{{figures/xsec/cross_omega_1}.pdf}
\caption[]{\label{fig:xsec.omega1}Differential cross sections for the reaction γ p $\rightarrow$ p ω based on the dominant decay mode ω $\rightarrow$ π$^+$ π$^-$ π$^0$ with a beam energy from 1.55 to 2.7~GeV,  compared to g11 (red).}
\end{center}\end{figure}


\begin{figure}[htpb]\begin{center}
\includegraphics[width=\columnwidth]{{figures/xsec/cross_omega_2}.pdf}
\caption[]{\label{fig:xsec.omega2}Differential cross sections for the reaction γ p $\rightarrow$ p ω based on the dominant decay mode ω $\rightarrow$ π$^+$ π$^-$ π$^0$ with a beam energy from 2.75 to 3.8~GeV. Comparison to g11 is in red.}
\end{center}\end{figure}


\begin{figure}[htpb]\begin{center}
\includegraphics[width=0.5\columnwidth]{{figures/xsec/cross_omega_ratio}.pdf}
\caption[]{\label{fig:xsec.omega.ratio}g12/g11 $\omega$ cross section ratio distribution  for the data shown in Figs.~\ref{fig:xsec.omega1} and \ref{fig:xsec.omega2}.}
\end{center}\end{figure}


\begin{figure}[htpb]\begin{center}
\includegraphics[width=\columnwidth]{{figures/xsec/cross_omega_ratio_1}.pdf}
\caption[]{\label{fig:xsec.omegaR1}Ratio of the  $\omega$ (g12 divided by g11) differential cross sections for the reaction γ p $\rightarrow$ p ω based on the dominant decay mode ω $\rightarrow$ π$^+$ π$^-$ π$^0$ with a beam energy from 1.55 to 2.7~GeV. }
\end{center}\end{figure}


\begin{figure}[htpb]\begin{center}
\includegraphics[width=\columnwidth]{{figures/xsec/cross_omega_ratio_2}.pdf}
\caption[]{\label{fig:xsec.omegaR2}Ratio of the  $\omega$ (g12 divided by g11)differential cross sections for the reaction γ p $\rightarrow$ p ω based on the dominant decay mode ω $\rightarrow$ π$^+$ π$^-$ π$^0$ with a beam energy from 2.75 to 3.8~GeV. }
\end{center}\end{figure}
...
The Λ(1115) differential cross section was measured and compared to the \desg{g11a} results shown in Figs.~\ref{fig:lambda.dcs.1} and \ref{fig:lambda.dcs.2} with the pull distribution in Fig.~\ref{fig:lambda.dcs.pull}. The \desg{g12} data employed tight timing and fiducial cuts to minimize systematic uncertainty at the expense of larger statistical uncertainty and very low statistics at high energy and large angle.
