...
\caption[K$^*$ Mass]{\label{fig:resonances.kstar}K$^*$ mass from K$^+$ [π$^0$] in the reaction γ p $\rightarrow$ K$^+$ p π$^-$ [π$^0$], where p π$^-$ was constrained to the Λ(1115) mass.}
\end{center}\end{figure}
