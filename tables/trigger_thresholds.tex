...
\begin{center}
\begin{singlespacing}
\caption[Pretrigger Thresholds]{\label{tab:data.trig.thresholds}Pretrigger thresholds for the electromagnetic calorimeter (\abbr{EC}) and \v{C}erenkov (\abbr{CC}) subsystems.}
